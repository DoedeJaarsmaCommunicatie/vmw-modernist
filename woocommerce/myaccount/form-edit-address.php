...
if( class_exists( 'Timber' ) && false) {
    ...
    $context['title'] = ($load_address === 'billing') ? __('Billing address', 'woocommerce') : __('Shipping address', 'woocommerce');
    $context['load_address'] = $load_address;
    
    \Timber\Timber::render('templates/woocommerce/account/partials/form-edit-address.twig');
} else {
